...
def TotalofUnit():
    ...
    Sub_Total_of_Unit = "R" + str((Prices_Drinks + Prices_Food))
    SubTotal.set(Sub_Total_of_Unit)

    Tax = "R" + str('%.2f'%((Prices_Drinks + Prices_Food) * 0.18))
    PaidTax.set(Tax)

    TT = ((Prices_Drinks + Prices_Food) * 0.18)
    TC = "R" + str((Prices_Drinks + Prices_Food + 2.00 + TT))
    TotalCost.set(TC)
